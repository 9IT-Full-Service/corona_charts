...
def probes():
    ...
    return render_template('probes_line_chart.html', title='Corona Probes', max=36000, labels=line_labels, values=line_values)
...
def averagebar():
    ...
    return render_template('averagebar_chart.html', title='Corona 7-Tage Durchschnitt ', max=20, labels=bar_labels, values=bar_values)
